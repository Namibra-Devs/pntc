...
<body>
	...
	<div class="agileits-services text-center py-5">
		<div class="container py-md-4 mt-md-3">
			<h3 class="heading-agileinfo">Email Verification <span>
					Enter a valid email address for verification</br>
			...
			<div class="w3ls_gallery_grids mt-md-5 pt-5">
				<div class="container">
					...
					<form class="form-login" method="post" id="verify-email">
						<h2 class="form-login-heading" style="color: #eb1d50;">Verify Email</h2>
						<hr />
						<div id="error">
						</div>
		...
		$('document').ready(function() {
			...
			function verifyEmail() {
				...
				$.ajax({
					...
					beforeSend: function() {
						$("#error").fadeOut();
						$("#login_button").html('<span class="glyphicon glyphicon-transfer"></span> &nbsp; sending verification mail ...');
					},
