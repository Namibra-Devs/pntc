					...
					<form class="form-login" method="post" action="process.php" enctype='multipart/form-data'>
						...
						<div class="input-group" style="margin-bottom:10px">
							...
							<select style='height:37px;width:100%;border:1px solid black;' name="courseapplied1" id='courseapplied1'>
								...
								<option <?php if ($choice1 == 'Nursing') echo 'selected'; ?>>Nursing</option>
								<option <?php if ($choice1 == 'Midwifery') echo 'selected'; ?>>Midwifery</option>
								<option <?php if ($choice1 == 'Nutrition') echo 'selected'; ?>>Nutrition</option>
								<option <?php if ($choice1 == 'Medical Laboratory Technology') echo 'selected'; ?>>Medical Laboratory Technology</option>
							</select>
						</div>
						<div class="input-group" style="margin-bottom:10px">
							...
							<select style='height:37px;width:100%;border:1px solid black;' name="courseapplied2" id='courseapplied2'>
								<option>Select Choice</option>
								<option <?php if ($choice2 == 'Nursing') echo 'selected'; ?>>Nursing</option>
								<option <?php if ($choice2 == 'Midwifery') echo 'selected'; ?>>Midwifery</option>
								<option <?php if ($choice2 == 'Nutrition') echo 'selected'; ?>>Nutrition</option>
								<option <?php if ($choice2 == 'Medical Laboratory Technology') echo 'selected'; ?>>Medical Laboratory Technology</option>
							</select>
						</div>
