                     ...
                     function(isConfirm){
                                      if (isConfirm) {                                      	
                                               ...
                                               $.ajax ({
                                                      type : 'POST',
                                                      url: "process.php",
                                                      data: {delgrade:myValue },
                                                      success: function(result) {
                                                      if(result=="ok"){
                                                                    swal({title: "Moved to trush!", text: "You have successfully deleted grade", type: "success"},
                                                          function(){ 
                                                                          location.reload();
                                                                          }
                                                                      );                               	                        
	                                            ...
	                                            swal("Cancelled", "Your grade category is safe:)", "error");
                                             }
                                         });
                 ...
                 <!-- /. ROW  -->
                  ...
                  if(isset($_SESSION['upload'])) {
                  	...
                  	<div class="alert alert-success">                        	
                             Grade  (<?php echo$_SESSION['upload']; session_destroy(); ?> ) has been added
                        </div>
                        <?php
				  }else{?>
...
<form class="form-login" style="width: 100%" method="post" action="process.php">
  ...
  <div class="input-group" style="margin-bottom:10px">
   ...
   <input type="text" class="form-control" name="schoolgrade" value=""  placeholder="Enter Grade Name">
  </div>
    ...
    <div style="float:right;margin-right:10%;margin-top:-9%"> 
    	                <div class="alert alert-info">                        	
                             List of Available Grades Category in the system.
                        </div>             	
<?php
