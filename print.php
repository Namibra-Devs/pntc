...
<!-- gallery -->
 ...
 <div id="printableArea">
      ...
      <p>THE PREMIER NURSING COLLEGE<br>PNTC<br>Admission form for 2024-2019 Academic session</p>                                  
	                                  ...
	                                  <table  class='table table-bordered' style="width:60%;">
                                                                      <thead>
                                                                        ...
                                                                        <tbody>
                                                                        	<tr>
                                                                              <td class="success">APLICATION NUMBER <?php if(isset($id)){echo$id; }?></td>
                                                                        	...
                                                                        	<tr >
                                                                              <td class="success">Name</td>
                                                                               <td><?php if(isset($firstname)){echo$firstname.' '.$sirname;} ?></td>
                                                                              <td></td> 
                                                                              <td></td> 
	                                                                                      ...
	                                                                                      $numb=mysqli_num_rows($rgetb2);
                                                                                            if($numb!=0){
                                                                                                 while($foundl = mysqli_fetch_array($rgetb2))
	                                                                                                {
                                                                                                        $dob= $foundl['DOB'];$gender= $foundl['Gender'];
																										$country= $foundl['Country'];$lgvt= $foundl['Localgvt'];
																										$state= $foundl['State'];$crapp= $foundl['Appcoraddress'];
																										
																										$gplace= $foundl['Gplace'];$gname= $foundl['Gname'];
																										$ghome= $foundl['Ghometown'];$gcountry= $foundl['Gcountry'];
																										$gstate= $foundl['Gstate'];$appre= $foundl['Appresaddress'];
																										
																										$glocal= $foundl['Glocalgvt'];$gaddres= $foundl['Gaddress'];
																										$gmobile= $foundl['Gmobile'];$appphone= $foundl['Applicantphone'];
																										$email= $foundl['Email'];$hometown= $foundl['Hometown'];
                                                                              ...
                                                                              <td><?php if(isset($state)){echo$state;} ?></td>                                                                             
                                                                              </tr>
                                                                              <tr >
                                                                              <td class="success">Local Government</td>
                                                                               <td><?php if(isset($lgvt)){echo$lgvt;} ?></td> 
                                                                               <td class="success">Hometown</td>
                                                                               <td><?php if(isset($hometown)){echo$hometown;} ?></td>                                                                                                                                                            
                                                                                                                                                                                                                                      
                                                                              </tr>
                                                                              <tr>
                                                                               <td class="success">Postal Address</td>
                                                                               <td><?php if(isset($crapp)){echo$crapp; }?></td> 
                                                                                <td></td> 
                                                                                  <td></td>                                                                                                                                                           
                                                                              </tr>
                                                                              <tr>
                                                                               <td class="success">Residential Address</td>
                                                                               <td><?php if(isset($appre)){echo$appre;} ?></td>
                                                                                <td></td> 
                                                                                  <td></td>                                                                                                                                                             
                                                                              </tr>
