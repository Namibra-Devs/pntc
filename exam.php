...
<script type="text/javascript"> 
    ...
    <div id="wrapper" >
         <div class="navbar navbar-inverse navbar-fixed-top" style="background-color:#eb1d50;">
                 ...
                 <!-- /. ROW  -->
                  ...
                  if(isset($_SESSION['upload'])) {
                  	...
                  	<div class="alert alert-success">                        	
                             Exam Type  (<?php echo$_SESSION['upload']; session_destroy(); ?> ) has been added
                        </div>
                        <?php
				  }else{?>
...
<form class="form-login" style="width: 100%" method="post" action="process.php">
  ...
  <div class="input-group" style="margin-bottom:10px">
   ...
   <input type="text" class="form-control" name="examtype" value=""  placeholder="Enter Exam Type">
  </div>

   
      	<div class="form-group">
			<button type="submit" class="btn btn-default" name="loginx" value="ghj" >
